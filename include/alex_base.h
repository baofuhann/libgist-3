 ...
 * for the bitmap, cost model weights, statistic accumulators for collecting cost model
 * statistics, and other miscellaneous functions
 */
...
//  #include <random>
 ...
 // Linear regression model
     ...
     public:
         ...
         /*
         * Perform statistical updates on data points, preparing for subsequent 
         * computations required to construct a linear model. 
         * Each call to the add function processes a single data point and updates the relevant statistics.
         * - Accept a data point as input.
         * - Update statistics necessary for linear model computations, including:
