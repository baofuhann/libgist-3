...
public:
    ...
    gist_penalty_t &operator=(const gist_penalty_t &pen)
    {
        p = pen.p;
        return *this;
    }
    gist_penalty_t &operator=(double pen)
    {
        p = pen;
        return *this;
    }
...
public:
    ...
    gist_ext_t(
        ...
        ParseFct parsePred,
        ParseFct parseData,
        ParseQueryFct parseQuery) : myId(id), myName(name), printPred(printPred), printData(printData),
